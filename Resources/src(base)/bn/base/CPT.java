 ...
 * row for every combination of Values for the parents (an ArrayMapAssignment), and
 ...
 * ArrayMapAssignment, and probabilities for each of the variable's Values.
 */
public class CPT implements bn.core.CPT {
	...
	/**
	 * Return the ``row'' (Distribution) for the given ArrayMapAssignment in this CPT.
	...
	/**
	 * Add a ``row'' (Distribution) for the given ArrayMapAssignment to this CPT.
	 */
	 ...
	 * given the values of its parents in the given ArrayMapAssignment, to the double p.
	 */
	@Override
	 ...
	 * given the values of its parents in the given ArrayMapAssignment.
	 ...
	 * ArrayMapAssignment and Value in this CPT.
	 */
	@Override
